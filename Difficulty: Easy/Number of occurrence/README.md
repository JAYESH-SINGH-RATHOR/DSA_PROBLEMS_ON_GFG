<h2><a href="https://www.geeksforgeeks.org/problems/number-of-occurrence2259/1?page=3&category=Arrays,Strings,Dynamic%20Programming,Sorting,Hash,Tree,Linked%20List,Stack,Binary%20Search,two-pointer-algorithm,Searching,Binary%20Search%20Tree,sliding-window,Queue,Map,Divide%20and%20Conquer,set,Kadane,Pointers&company=Amazon&sortBy=submissions">Number of occurrence</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a&nbsp;<strong>sorted&nbsp;</strong>array, <strong>arr[] </strong>and a number&nbsp;<strong>target</strong>, you need to find the number of occurrences of<strong>&nbsp;target</strong>&nbsp;in&nbsp;<strong>arr[]</strong>.&nbsp;</span></p>
